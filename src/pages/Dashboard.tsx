...
const stats = [
  ...
  { label: 'Active Sessions', value: '12', icon: Activity, trend: 'Live', color: 'warning' },
              ...
              <Card className="p-6 hover:shadow-2 transition-all group">
                <div className="flex items-center justify-between mb-4">
                  <div className={cn(
                    ...
                    stat.color === 'accent' && "bg-primary-accent/10 text-primary-accent",
                ...
                <div>
                  <p className="text-small text-muted font-medium">{stat.label}</p>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <Button variant="secondary" className="h-24 flex-col gap-2 bg-white border-dashed border-2">
                  <Plus size={24} />
              ...
              <div className="divide-y divide-border">
                {activities.map((activity, i) => (
                  <div key={i} className="p-4 flex items-start gap-4 hover:bg-black/[0.01] transition-colors">
                    <div className="w-10 h-10 rounded-full bg-surface flex items-center justify-center text-primary-accent font-bold text-sm shrink-0 border border-primary-accent/20">
                      {activity.user}
                    </div>
