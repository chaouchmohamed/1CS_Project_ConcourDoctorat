...
export const Card = ({ children, className, variant = 'default' }: { children: React.ReactNode; className?: string; variant?: 'default' | 'surface' }) => {
  return (
    <div className={cn(variant === 'default' ? 'card' : 'card-surface', className)}>
      {children}
    </div>
  );
};
